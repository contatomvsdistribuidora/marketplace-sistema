...
async function startServer() {
  ...
  app.get("/api/run-migrations", async (req, res) => {
    ...
    const statements: { name: string; sql: string }[] = [
      ...
      // 0015: Category 100630 — Armazenamento de Alimentos with mandatory Marca
      { name: "seed:shopee_category_attributes:100630", sql: `INSERT INTO \`shopee_category_attributes\` (\`categoryId\`,\`categoryName\`,\`attributeList\`,\`source\`) VALUES (100630,'Armazenamento de Alimentos','[{"attribute_id":100439,"attribute_name":"Marca","is_mandatory":true,"input_type":"DROP_DOWN","input_validation_type":"STRING_TYPE","options_list":[{"value_id":0,"display_value_name":"Sem marca","original_value_name":"Sem marca"}]},{"attribute_id":100436,"attribute_name":"País de Origem","is_mandatory":false,"input_type":"DROP_DOWN","input_validation_type":"STRING_TYPE","options_list":[{"value_id":1,"display_value_name":"Brasil","original_value_name":"Brasil"},{"value_id":2,"display_value_name":"China","original_value_name":"China"},{"value_id":3,"display_value_name":"Outros","original_value_name":"Outros"}]},{"attribute_id":100437,"attribute_name":"Material","is_mandatory":false,"input_type":"DROP_DOWN","input_validation_type":"STRING_TYPE","options_list":[{"value_id":10,"display_value_name":"Plástico","original_value_name":"Plástico"},{"value_id":11,"display_value_name":"Vidro","original_value_name":"Vidro"},{"value_id":12,"display_value_name":"Aço Inox","original_value_name":"Aço Inox"},{"value_id":13,"display_value_name":"Silicone","original_value_name":"Silicone"}]},{"attribute_id":100441,"attribute_name":"Capacidade de Volume","is_mandatory":false,"input_type":"TEXT_FIELD","input_validation_type":"STRING_TYPE","options_list":[]},{"attribute_id":100442,"attribute_name":"Quantidade","is_mandatory":false,"input_type":"INT_TYPE","input_validation_type":"INT_TYPE","options_list":[]}]','seed') ON DUPLICATE KEY UPDATE \`categoryName\`=VALUES(\`categoryName\`),\`attributeList\`=VALUES(\`attributeList\`),\`source\`=VALUES(\`source\`)` },
    ];
